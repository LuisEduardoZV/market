...
const CardMenu = ({ img, category, id, setSelected }) => {
  ...
  return (
    <Col ref={card} id={`shadow-img-menu-${id}`} span={5} className='shadow-img-menu' style={{ position: 'relative', width: '100%', backgroundImage: `url(${img})`, minHeight: 140, backgroundSize: '100%', backgroundPosition: 'center', display: 'flex', justifyContent: 'center', alignItems: 'stretch', cursor: 'pointer' }} onClick={() => setSelected(id)}>
